...
export default function SecurityPage() {
  ...
  return <main className="mx-auto w-full max-w-3xl p-4 sm:p-6">
    <header className="mb-6"><p className="text-sm font-medium text-primary">Paramètres</p><h1 className="mt-1 font-title text-2xl font-semibold text-zinc-900">Sécurité et confidentialité</h1><p className="mt-2 text-sm text-zinc-600">Protégez l’accès à votre compte.</p></header>
    <section className="rounded-2xl border border-zinc-200 bg-white p-5 sm:p-6"><div className="flex items-start gap-3 border-b border-zinc-100 pb-5"><div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary/10 text-primary"><KeyRound className="h-5 w-5" /></div><div><h2 className="font-semibold text-zinc-900">Modifier le mot de passe</h2><p className="mt-1 text-sm text-zinc-500">Choisissez un mot de passe d’au moins 8 caractères.</p></div></div>
