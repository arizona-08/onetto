...
describe('PdfService', () => {
  it('génère un PDF non vide pour une facture complète', async () => {
    const pdf = await new PdfService().generate({
      type: 'INVOICE', documentNumber: '#FACT-2026-0001', createdAt: new Date('2026-08-11'), sentAt: new Date('2026-08-11'), paymentDueAt: new Date('2026-09-11'), clientName: 'Client', clientEmail: 'client@example.test', clientAddress: '1 rue du Test', clientPostalCode: '75001', clientCity: 'Paris', clientCountry: 'France', totalPrice: 120, totalPriceExcludingTax: 100,
